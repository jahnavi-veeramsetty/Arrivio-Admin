import { X, ShieldCheck, Trash2, Undo2, AlertCircle, FileText } from 'lucide-react';
          ...
          <div className="bg-blue-50/50 dark:bg-blue-900/10 p-4 rounded-2xl border border-blue-100 flex gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-blue-700 font-bold leading-relaxed">
                Funds are secured in Arrivio&apos;s segregated deposit account and reconciled against tenant ledgers before release.
              </p>
            </div>
          </div>
        </div>
