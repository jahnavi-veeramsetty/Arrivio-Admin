          ...
          <div key={i} className="p-4 hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
            <div className="flex justify-between items-start mb-2">
              <div>
                ...
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">{inv.id} · {inv.period}</p>
              </div>
              <div className="text-right">
                <p className="text-sm font-black text-red-600">£{inv.amount.toLocaleString()}</p>
                <p className="text-[9px] font-bold text-red-400 uppercase tracking-tight">16 Days Overdue</p>
              </div>
            </div>
