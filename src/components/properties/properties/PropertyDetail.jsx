import { X, MapPin, Building, Users, Settings, Plus, Camera, Trash2, ShieldCheck, List } from 'lucide-react';
      ...
      <div className="relative w-full max-w-4xl bg-[#f8f8f6] dark:bg-gray-900 shadow-2xl animate-in slide-in-from-right duration-500 overflow-y-auto">
        <div className="sticky top-0 z-20 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 p-8 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="w-16 h-16 rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white dark:border-gray-800 rotate-3">
            ...
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase italic bg-green-50 text-green-700">
                  {property.status}
                </span>
              </div>
        ...
        <div className="p-8 space-y-10 pb-24">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="md:col-span-3 grid grid-cols-3 gap-4 bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base font-bold flex items-center gap-2"><Building size={14} className="text-blue-600" /> {property.rooms} Rooms</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm relative overflow-hidden">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-[11px] font-black uppercase tracking-widest flex items-center gap-2">
                  <Users size={16} className="text-[#1a6644]" /> Revenue Summary
                </h3>
              </div>
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800">
                  ...
                  <span className="text-xl font-black italic">€{property.monthlyRevenue.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800">
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{property.category}</p>
                  <span className="text-xl font-black italic">{property.rooms} rooms</span>
                </div>
              </div>
            </section>
            ...
            <section className="bg-gray-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden">
              ...
              >
                {(property.occupancyRate || 0) > 0 ? 'Archive Blocked (Asset Occupied)' : 'Archive Property'}
              </button>
            </section>
          </div>
        </div>
