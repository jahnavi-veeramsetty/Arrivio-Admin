import { MapPin, Building, Users, ArrowRight } from 'lucide-react';
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto grid grid-cols-2 gap-4 pt-4 border-t border-gray-50 dark:border-gray-700">
           ...
           <div className="space-y-1 text-right">
              <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest block">Manager</span>
              <div className="flex items-center gap-2 justify-end text-gray-700 dark:text-gray-300">
                 <Users size={14} className="text-gray-300" />
                 <span className="text-xs font-black truncate">{property.manager.split(' ')[0]}</span>
              </div>
           </div>
        </div>
      </div>
